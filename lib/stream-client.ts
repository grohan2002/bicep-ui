...
import type { StreamEvent, ToolCallInfo, TerraformFiles } from "./types";
...
export interface ConversionCallbacks {
  ...
  onDone: (fullReply: string, toolCalls: ToolCallInfo[]) => void;
...
function dispatchEvent(
  ...
  switch (event.type) {
    ...
    case "progress":
      ...
      break;
    case "done":
      callbacks.onDone(event.fullReply, event.toolCalls);
      break;
    case "error":
